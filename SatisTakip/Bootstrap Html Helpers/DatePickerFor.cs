...
namespace System.Web.Mvc.Html
{
    public static partial class HtmlHelper
    {
            ...
            (this HtmlHelper<TModel> self, Expression<Func<TModel, TValue>> expression, [Optional] params string[] DataAPIParameters)
        {
            ...
            input.Attributes.Add("onkeypress", "format('DD/MM/YYYY', this); function format(mascara, documento) { var i = documento.value.length; var saida = mascara.substring(0, 1); var texto = mascara.substring(i); if (texto.substring(0, 1) != saida) { documento.value += texto.substring(0, 1); } }");
            ...
            {
                input.Attributes.Remove("data-date-" + p.Split('=')[0]);
